    ...
    <section className="py-16 px-4 bg-muted/30">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <h2 className="font-serif text-3xl md:text-4xl font-bold text-[var(--coffee-primary)] mb-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="text-center">
            <CardContent className="p-6">
              <div className="w-12 h-12 coffee-gradient rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <div className="flex justify-center space-x-4">
                <a href="#" className="text-muted-foreground hover:text-[var(--coffee-primary)] transition-colors">
